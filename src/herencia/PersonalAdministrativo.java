 ...
 * Clase para obtener la informacion de la Persona Administrativo
 * @ autor: Gael Guerrero
 * @ version: 7.9.25
...
public class PersonalAdministrativo extends Persona {
    // Constantes
    private double SUELDO_DIARIO = 250.0;
    ...
    // Constructor
    public PersonalAdministrativo(String nombre, String apellido, int edad, int diasTrabajados, int faltas) {
